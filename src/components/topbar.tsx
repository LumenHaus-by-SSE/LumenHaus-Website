...
const Topbar = () => {
  ...
  return (
    <div className="fixed top-0 z-999 w-full bg-black">
      <div className="hidden w-full p-8 bg-[#1d1d1d] text-white lg:flex items-center justify-center h-24">
        <div className="w-3/5 flex items-center justify-between">
          <div className="flex items-center justify-between gap-10">
            <Link href="/" className="flex gap-2 items-center justify-center">
              <IoLocationSharp className="text-2xl text-[#e4bb7d]" />{" "}
              <h1 className="text-sm">123th RoundStreet, Pekanbaru</h1>
            </Link>
            <Link href="tel:000123456789" className="flex gap-2 items-center justify-center">
              <IoCall className="text-2xl text-[#e4bb7d]" />{" "}
              <h1 className="text-sm">000 123 456 789</h1>
            </Link>
          </div>
          <div>
            <div className="flex gap-2 items-center justify-center">
              <FaClock className="text-2xl text-[#e4bb7d]" />{" "}
              <h1 className="text-sm">Opening: Mon-Fri 08:00 - 17:00</h1>
            </div>
          </div>
        </div>
      </div>
