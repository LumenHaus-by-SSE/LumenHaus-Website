  ...
  return (
    <section className="w-full flex flex-col items-center py-16 px-4 bg-white">
      ...
      <div className="max-w-3xl w-full flex flex-col items-center mb-8">
        <div className="text-[#E6B17A] text-sm font-semibold mb-8 text-center">
          OUR PROJECT
        </div>
        <h1 className="text-3xl md:text-4xl font-bold text-[#222] mb-8 text-center">
          OUR LATEST PROJECT
        </h1>
        <p className="text-xs md:text-sm text-[#444] text-center max-w-2xl mb-8">
